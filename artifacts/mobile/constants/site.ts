// Canonical public web URL for mapper.one.
//
...
// mapper.one. Note: API and auth calls still use EXPO_PUBLIC_DOMAIN (see
...
export const WEB_BASE_URL =
  process.env.EXPO_PUBLIC_WEB_BASE_URL?.trim() || "https://mapper.one";
